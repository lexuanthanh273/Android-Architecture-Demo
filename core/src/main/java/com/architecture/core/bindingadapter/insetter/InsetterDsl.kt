 ...
 *     type(navigationBars = true) {
 *         // AddCommand the left/right to the margin
 *         margin(left = true, right = true)
 *         // AddCommand the bottom to padding
 *         padding(bottom = true)
 *     }
 * }
 * ```
...
class InsetterApplyTypeDsl internal constructor(
    ...
    /**
     * AddCommand the [WindowInsetsCompat.Type] to all padding dimensions.
     *
    ...
    /**
     * AddCommand the [WindowInsetsCompat.Type] to the given padding dimensions.
     *
     * @param left AddCommand the left value of the insets to the left padding.
     * @param top AddCommand the left value of the insets to the top padding.
     * @param right AddCommand the left value of the insets to the right padding.
     * @param bottom AddCommand the left value of the insets to the bottom padding.
     * @param horizontal AddCommand both the left and right values.
     * @param vertical AddCommand both the top and bottom values.
     * @param animated Whether we should animate the padding whilst a window insets animation
     * with the type is ongoing.
     */
    fun padding(
    ...
    /**
     * AddCommand the [WindowInsetsCompat.Type] to all margin dimensions.
     *
    ...
    /**
     * AddCommand the [WindowInsetsCompat.Type] to the given margin dimensions.
     *
     * @param left AddCommand the left value of the insets to the left padding.
     * @param top AddCommand the left value of the insets to the top padding.
     * @param right AddCommand the left value of the insets to the right padding.
